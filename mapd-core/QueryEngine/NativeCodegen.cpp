...
declare i32 @hash31(i64, i64, i64);
declare i32 @CW2B(i64, i64, i64, i32);
declare i32 @seq_xor(i32);
declare i32 @EH3(i32, i32, i32);
declare void @agg_count_and_update_sketch_gpu(i64*, i64*, i8, i64*, i32*, i32*, i32*, i16, i16, i64, i64);
  ...
  for (size_t target_idx = 0, agg_col_idx = 0; target_idx < target_exprs.size(); ++target_idx, ++agg_col_idx) {
    ...
    switch (agg_type) {
      ...
      case kAPPROX_COUNT_DISTINCT:
        ...
        break;
      case kFAGMS_SKETCH:
        result.push_back("agg_count_and_update_sketch");
        break;
      default:
        CHECK(false);
    }
